...
class MypagesControllerTest < ActionController::TestCase
  ...
  test "should create mypage" do
    assert_difference('Mypage.count') do
      post :create, mypage: { address: @mypage.address, generate: @mypage.generate, mypage: @mypage.mypage, name: @mypage.name, ontime: @mypage.ontime, rails: @mypage.rails, scaffold: @mypage.scaffold }
    end
  ...
  test "should update mypage" do
    put :update, id: @mypage, mypage: { address: @mypage.address, generate: @mypage.generate, mypage: @mypage.mypage, name: @mypage.name, ontime: @mypage.ontime, rails: @mypage.rails, scaffold: @mypage.scaffold }
    assert_redirected_to mypage_path(assigns(:mypage))
  end
